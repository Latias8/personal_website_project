let makeItRain = function() {
    ...
    while (increment < 100) {
        ...
        //let preDrop = document.createElement('div');
    ...
    /*document.querySelectorAll('.rain').forEach((rain) => {
        let road = document.getElementById('road').getBoundingClientRect();
        rain.style.height = `${road.height + road.top}px`;
    })*/
}
